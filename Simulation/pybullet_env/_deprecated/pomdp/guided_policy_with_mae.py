...
from pomdp.policy.random_pickplace import SampleRandomTopPick
from pomdp.common import process_history_v_value


class FetchingGuidedPolicyPlaceWithMAE(PolicyModel):
    ...
    class Config(Serializable):
        ...
        # Experiment setup
        exp_name: str = "4.24_policy_pref_April17th_sim_dataset_dim256_beta1.0_batch16_num_action64_lr0.0001_temp1.0"
        weight  : str = "best.pth"
    ...
    def __init__(self, bc     : BulletClient, 
        ...
        # Pick sampler
        self.pick_action_sampler = SampleRandomTopPick(
        ...
        self.model = HistoryPlacePolicyonlyWithMAE( 
    ...
    def sample(self, init_observation: FetchingObservation, 
        ...
        # PICK action
        if type == ACTION_PICK:
            next_action = self.pick_action_sampler(self.bc, self.env, self.robot, self.manip, state)
