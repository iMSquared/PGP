...
from .utils import RRT_RESTARTS, RRT_SMOOTHING, INF, irange, elapsed_time, compute_path_cost, default_selector, MAX_TIME
...
def random_restarts(solve_fn, start, goal, distance_fn, sample_fn, extend_fn, collision_fn,
                    ...
                    success_cost=0., max_time=MAX_TIME, max_solutions=1, verbose=False, **kwargs):
    """
    :param start: Start configuration - conf
    :param goal: End configuration - conf
